...
namespace FPSProfiler
{
    ...
    public:
        ...
        explicit FPSProfilerSystemComponent(const FPSProfilerConfigFile& config, bool profileOnGameStart);
    ...
    private:
        ...
        FPSProfilerConfigFile m_configuration; //!< Stores editor settings for the profiler
