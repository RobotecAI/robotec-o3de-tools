...
| [**DisableMainView**](#disablemainview)               | compatible    |
...
| [**LevelModificationTools**](#levelmodificationtools) | compatible    |
| [**Pointcloud**](#pointcloud)                         | compatible    |
| [**RandomizeUtils**](#randomizeutils)                 | compatible    |
| [**RobotecRecordingTools**](#robotecrecordingtools)   | compatible    |
...
A gem that allows to disable the main view - useful for debugging. 
