...
namespace RobotecRecordingTools
{
    AZ_COMPONENT_IMPL(
        ...
        "RobotecRecordingToolsEditorSystemComponent",
        RobotecRecordingToolsEditorSystemComponentTypeId,
        BaseSystemComponent);
    ...
    void RobotecRecordingToolsEditorSystemComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        {
            serializeContext->Class<RobotecRecordingToolsEditorSystemComponent, RobotecRecordingToolsSystemComponent>()->Version(0);
        }
    }
    ...
    void RobotecRecordingToolsEditorSystemComponent::GetRequiredServices(
        [[maybe_unused]] AZ::ComponentDescriptor::DependencyArrayType& required)
    {
        BaseSystemComponent::GetRequiredServices(required);
    }

    void RobotecRecordingToolsEditorSystemComponent::GetDependentServices(
